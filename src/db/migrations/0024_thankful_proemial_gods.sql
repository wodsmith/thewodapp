...
ALTER TABLE `generated_schedules` ADD `location_id` text NOT NULL REFERENCES locations(id);--> statement-breakpoint
ALTER TABLE `locations` ADD `capacity` integer DEFAULT 20 NOT NULL;--> statement-breakpoint
ALTER TABLE `schedule_templates` ADD `class_catalog_id` text NOT NULL REFERENCES class_catalog(id);--> statement-breakpoint
ALTER TABLE `schedule_templates` ADD `location_id` text NOT NULL REFERENCES locations(id);--> statement-breakpoint
