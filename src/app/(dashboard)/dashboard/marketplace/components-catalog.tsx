...
export const COMPONENTS: MarketplaceComponent[] = [
	{
		...
		name: "Team Switcher",
		description:
			"A sleek dropdown menu for switching between teams with custom logos and plans",
		credits: 4,
	...
	},
	{
		...
		name: "Theme Switch",
		description:
			"An animated theme switcher with system, light, and dark mode options",
		credits: 4,
		preview: () => <ThemeSwitch />,
	},
	{
		...
		description:
			"A clean separator component with customizable text and styling",
		credits: 3,
	...
	},
	{
		...
		description:
			"A professional user navigation dropdown with avatar, user info, and action items",
		credits: 10,
		containerClass: "w-[300px]",
		preview: () => <NavUser />,
	},
	{
		...
		description:
			"A responsive page header with collapsible sidebar trigger and breadcrumb navigation",
		credits: 12,
		containerClass: "w-full",
		preview: () => (
			<PageHeader
