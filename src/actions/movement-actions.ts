...
import { getAllMovements, createMovement, getMovementById, getWorkoutsByMovementId } from "@/server/movements";
...
export type CreateMovementActionInput = z.infer<typeof createMovementActionSchema>;
...
export const getWorkoutsByMovementIdAction = createServerAction()
  ...
  .handler(async ({ input }) => {
    try {
      ...
      throw new ZSAError("INTERNAL_SERVER_ERROR", "Failed to get workouts by movement");
    }
  });