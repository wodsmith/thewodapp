	...
	return (
		<section className="bg-background min-h-[90vh] flex items-center relative overflow-hidden">
			...
			<div className="absolute inset-0">
				...
				<div className="absolute top-1/2 right-1/3 w-16 h-16 bg-orange border-4 border-primary transform rotate-45 hidden lg:block" />
			</div>
					...
					<div>
						<div className="flex items-center space-x-2 mb-6">
							<div className="flex space-x-1">
								...
								<TrophyIcon className="text-orange" />
							</div>
						...
						<h1 className="font-mono text-4xl md:text-6xl lg:text-7xl text-primary leading-tight mb-6">
							TRACK YOUR
							<br />
							<span className="text-orange">WORKOUTS</span>
							<br />
							LIKE A BEAST
						</h1>

						<p className="font-sans text-xl md:text-2xl text-primary mb-8 leading-relaxed">
						...
						<div className="flex flex-col sm:flex-row gap-4 mb-8">
							<Button
								size="lg"
								asChild
								className="bg-orange border-4 border-primary font-mono text-xl px-8 py-6 text-white hover:bg-orange-600 shadow-[6px_6px_0px_0px] shadow-primary hover:shadow-[8px_8px_0px_0px] hover:shadow-primary transition-all"
							>
								<Link href="/sign-up">
									START TRACKING FREE
							...
							<Button
								...
								size="lg"
								asChild
								className="border-4 border-primary font-mono text-xl px-8 py-6 text-primary bg-background hover:bg-secondary shadow-[6px_6px_0px_0px] shadow-primary"
							>
								<a
						...
						<div className="flex items-center space-x-8 text-primary">
							...
							<div className="w-px h-12 bg-primary" />
							<div className="text-center">
								<div className="font-mono text-3xl text-orange">4.9★</div>
						...
						<div className="bg-primary border-4 border-primary rounded-3xl p-4 max-w-sm mx-auto shadow-[12px_12px_0px_0px] shadow-accent">
							<div className="bg-background rounded-2xl p-6 h-96 flex flex-col">
								<div className="flex justify-between items-center mb-6">
									...
									<div className="w-3 h-3 bg-orange rounded-full animate-bounce-subtle" />
								</div>
								...
								<div className="space-y-4 flex-1">
									...
									<div className="bg-brutal-surface border-2 border-primary p-3 rounded-lg">
								...
								<Button className="w-full bg-orange border-2 border-primary font-mono text-white mt-4">
									START WORKOUT
								</Button>
							</div>
						</div>
