...
Submission windows control when athletes can upload videos and scores for each event of an online competition.

1. Create a window with open and close date-times.
...
After a window closes, work through the videos from the **Results** page; see the review guide on each event's submissions page.
