...
Every review note must carry an immutable submission revision reference; timestamped video notes also carry the exact evidence revision and slot they annotate. Movement/no-rep children inherit that binding. Editing a note must not retarget it to newer evidence; retain its previous text or record a note amendment. Existing public votes likewise remain attached to the evidence version originally evaluated. Legacy notes/votes whose old evidence cannot be proven stay explicitly unbound rather than being reassigned to a fabricated baseline.
