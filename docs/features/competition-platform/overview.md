...
- `/compete/admin/{teamSlug}` - Competition dashboard for this organizing team
- `/compete/admin/{teamSlug}/events` - List all events for this team
- `/compete/admin/{teamSlug}/events/create` - Create new competition (auto-creates competition_event team)
- `/compete/admin/{teamSlug}/events/{eventSlug}` - Event overview and settings
- `/compete/admin/{teamSlug}/events/{eventSlug}/edit` - Edit event details

**Event Series/Groups (Admin-only organizational tool):**
- `/compete/admin/{teamSlug}/series` - Manage event series/groups
- `/compete/admin/{teamSlug}/series/create` - Create new event series
- `/compete/admin/{teamSlug}/series/{seriesSlug}` - View/edit series (shows all events in group)
...
**Revenue & Analytics:**
- `/compete/admin/{teamSlug}/revenue` - Revenue tracking and analytics
- `/compete/admin/{teamSlug}/analytics` - Competition performance metrics

**Example Admin URLs:**
- `/compete/admin/mwfc` - MWFC's competition dashboard
- `/compete/admin/mwfc/events` - All MWFC events
- `/compete/admin/mwfc/series/throwdowns` - Manage the Throwdowns series (CFR7, Verdant, etc.)
- `/compete/admin/mwfc/revenue` - MWFC revenue tracking
...
- `/compete/{competitionEventSlug}/workouts` - Schedule and manage workouts
- `/compete/{competitionEventSlug}/athletes` - Manage athlete registrations
- `/compete/{competitionEventSlug}/scores` - Score validation and management
- `/compete/{competitionEventSlug}/dashboard` - Event-specific dashboard

**Example Event Management URLs:**
- `/compete/mwfc-cfr7-2026/workouts` - Manage CFR7 workouts
- `/compete/mwfc-cfr7-2026/athletes` - Manage CFR7 athlete registrations
- `/compete/mwfc-cfr7-2026/scores` - Validate CFR7 scores
...
2. Navigate to `/compete/admin/mwfc` - Competition dashboard
3. Create "Throwdowns" event series at `/compete/admin/mwfc/series/create`
4. Create competitions at `/compete/admin/mwfc/events/create`:
...
5. Assign all three events to "Throwdowns" series at `/compete/admin/mwfc/series/throwdowns`
6. View revenue dashboard at `/compete/admin/mwfc/revenue`
...
- Admin URLs include team context: `/compete/admin/mwfc/...`
