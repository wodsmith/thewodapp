...
|-------|-------------|--------|----------|---------|------------|-------|
| **Landing Page** | `(compete)/compete/(public)/page.tsx` | ❌ Not Started | P0 | competition-actions.ts | competition-search.tsx, competition-section.tsx, competition-row.tsx | Competition search and listing |
| **Competition Detail** | `(compete)/compete/(public)/[slug]/(tabs)/page.tsx` | ❌ Not Started | P0 | competition-actions.ts | competition-hero.tsx, competition-tabs.tsx, registration-sidebar.tsx, competition-view-tracker.tsx, register-button.tsx | Main competition page with tabs (default: leaderboard) |
| **Leaderboard Tab** | `(compete)/compete/(public)/[slug]/(tabs)/leaderboard/page.tsx` | ❌ Not Started | P0 | competition-score-actions.ts | leaderboard-content.tsx, leaderboard-page-content.tsx, competition-leaderboard-table.tsx | Real-time leaderboard with division filtering |
| **Workouts Tab** | `(compete)/compete/(public)/[slug]/(tabs)/workouts/page.tsx` | ❌ Not Started | P1 | competition-actions.ts | workouts-content.tsx, workouts-skeleton.tsx, workout-card.tsx | Competition workouts display |
| **Schedule Tab** | `(compete)/compete/(public)/[slug]/(tabs)/schedule/page.tsx` | ❌ Not Started | P1 | competition-heat-actions.ts | schedule-content.tsx, schedule-skeleton.tsx, schedule-page-content.tsx, event-details-content.tsx | Heat schedule and event details |
...
| Route | Next.js Path | Status | Priority | Actions | Components | Notes |
|-------|-------------|--------|----------|---------|------------|-------|
| **Competition List** | `(compete)/compete/organizer/(dashboard)/page.tsx` | ❌ Not Started | P0 | competition-actions.ts | organizer-competitions-list.tsx, team-filter.tsx, pending-organizer-banner.tsx | Main organizer dashboard |
| **Create Competition** | `(compete)/compete/organizer/(dashboard)/new/page.tsx` | ❌ Not Started | P0 | competition-actions.ts | organizer-competition-form.tsx | Competition creation wizard |
...
| Route | Next.js Path | Status | Priority | Actions | Components | Notes |
|-------|-------------|--------|----------|---------|------------|-------|
| **Series List** | `(compete)/compete/organizer/(dashboard)/series/page.tsx` | ❌ Not Started | P2 | competition-actions.ts | organizer-series-list.tsx | Multi-competition series |
| **Create Series** | `(compete)/compete/organizer/(dashboard)/series/new/page.tsx` | ❌ Not Started | P2 | competition-actions.ts | organizer-series-form.tsx | Series creation |
| **Series Detail** | `(compete)/compete/organizer/(dashboard)/series/[groupId]/page.tsx` | ❌ Not Started | P2 | competition-actions.ts | (series detail) | Individual series management |
| **Edit Series** | `(compete)/compete/organizer/(dashboard)/series/[groupId]/edit/page.tsx` | ❌ Not Started | P2 | competition-actions.ts | (series edit form) | Series editing (FOUND IN AUDIT) |
