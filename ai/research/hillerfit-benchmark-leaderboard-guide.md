...
> **Status:** Implementation contract maintained during the phased benchmark build (**revision 3** — updated after M0a/M1/M2/M3 landed and M4 implementation began). This is the document Zac reviews before changing product scope or reopening fixed decisions.
