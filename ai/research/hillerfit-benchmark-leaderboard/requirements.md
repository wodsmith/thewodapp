...
- We are not building HillerFit-branded pages, routes, marketing surfaces, logos, or theme treatments. The UI remains WODsmith's generic benchmark board/stat-line experience.
...
Do not create a HillerFit-branded landing page or branded route as a substitute for missing seed data.
...
- No HillerFit-branded pages, routes, marketing copy, logos, visual theme, or product navigation.

## Definition Of Done

v1 is done when a seeded benchmark board can be created, a qualified athlete can submit scores, worse retests are ignored, valid scores appear immediately on the public board, the unified leaderboard ranks by Overall/100, the stats page renders the category breakdown, and the focused automated/manual tests in `test-strategy.md` pass.
