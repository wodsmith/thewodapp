...
describe('assignRanksWithTies - Expected tie-aware ranking behavior', () => {
  ...
  describe('tiebreaker values', () => {
    it('should tie when tiebreakValue matches', () => {
      ...
      const sortedScores = [
        {
          sortKey: '0000000000000500012',
          secondaryValue: null,
          tiebreakValue: 510000,
          status: 'scored',
        },
        {
          sortKey: '0000000000000500012',
  ...
  describe('even_spread scoring with ties', () => {
    ...
    it('should give tied athletes same even_spread points', () => {
      ...
      const results = assignRanksWithTies(
        sortedScores,
        5,
        evenSpreadCalculatePoints,
      )
...
describe('scheme-specific sorting behavior', () => {
  ...
  describe('ascending schemes (lower is better)', () => {
    it('time scheme: lower time ranks first', () => {
      ...
      const sortedScores = [
        ...
        {
          sortKey: '0000000000000360000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 6:00 = 360000ms
        {
          sortKey: '0000000000000420000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 7:00 = 420000ms
    ...
    it('emom scheme: lower score ranks first', () => {
      ...
      const sortedScores = [
        {
          sortKey: '0000000000000050000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
        {
          sortKey: '0000000000000075000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
        {
          sortKey: '0000000000000100000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
  ...
  describe('descending schemes (higher is better)', () => {
    ...
    it('rounds-reps scheme: higher rounds+reps ranks first', () => {
      ...
      const sortedScores = [
        {
          sortKey: '0000000000000500025',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 5+25
        {
          sortKey: '0000000000000400050',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 4+50
        {
          sortKey: '0000000000000300075',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 3+75
    ...
    it('load scheme: higher weight ranks first', () => {
      ...
      const sortedScores = [
        {
          sortKey: '0000000000102058500',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 225 lbs
        {
          sortKey: '0000000000083914620',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 185 lbs
        {
          sortKey: '0000000000061234920',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 135 lbs
    ...
    it('calories scheme: higher calories ranks first', () => {
      ...
      const sortedScores = [
        ...
        {
          sortKey: '0000000000000120000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
        {
          sortKey: '0000000000000090000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
    ...
    it('meters scheme: higher distance ranks first', () => {
      ...
      const sortedScores = [
        {
          sortKey: '0000000002000000000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 2000m
        {
          sortKey: '0000000001500000000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 1500m
        {
          sortKey: '0000000001000000000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 1000m
    ...
    it('feet scheme: higher distance ranks first', () => {
      ...
      const sortedScores = [
        {
          sortKey: '0000000000152400000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 500ft
        {
          sortKey: '0000000000121920000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 400ft
        {
          sortKey: '0000000000091440000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 300ft
    ...
    it('points scheme: higher points ranks first', () => {
      ...
      const sortedScores = [
        {
          sortKey: '0000000000000085000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
        {
          sortKey: '0000000000000070000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
        {
          sortKey: '0000000000000055000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        },
      ...
      const sortedScores = [
        {
          sortKey: '0000000000000500012',
          secondaryValue: null,
          tiebreakValue: 420000,
          status: 'scored',
        }, // 7:00 tiebreak (faster)
        {
          sortKey: '0000000000000500012',
          secondaryValue: null,
          tiebreakValue: 480000,
...
describe('overall ranking tiebreakers', () => {
   ...
   */
  function assignOverallRanks(
    entries: MockEntry[],
  ): Array<{athleteName: string; overallRank: number}> {
      ...
      const entries: MockEntry[] = [
        {
          athleteName: 'Alice',
          totalPoints: 100,
          eventResults: [{rank: 1, points: 100}],
        },
        {
          athleteName: 'Bob',
          totalPoints: 95,
          eventResults: [{rank: 2, points: 95}],
        },
        {
          athleteName: 'Carol',
          totalPoints: 95,
...
describe('integration tests - complete leaderboard scenarios', () => {
  ...
  describe('multi-event competition leaderboard', () => {
    it('should aggregate points correctly across multiple events', () => {
      ...
      const event1Results = assignRanksWithTies(
        event1Scores,
        4,
        mockCalculatePoints,
      )
  ...
  describe('division-specific leaderboards', () => {
    it('should rank athletes independently within each division', () => {
      ...
      const scaledScores = [
        ...
        {
          sortKey: '0000000000000480000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 8:00
        {
          sortKey: '0000000000000540000',
          secondaryValue: null,
          tiebreakValue: null,
          status: 'scored',
        }, // 9:00
      ...
      const scaledResults = assignRanksWithTies(
        scaledScores,
        3,
        mockCalculatePoints,
      )
  ...
  describe('real-world CrossFit Open scenario', () => {
    it('should rank Open-style workout with time cap and tiebreaks', () => {
      ...
      const sortedScores = [
        ...
        {
          sortKey: '0000000000000180000',
          secondaryValue: null,
          tiebreakValue: 120000,
          status: 'scored',
        }, // 3:00, tiebreak 2:00
        {
          sortKey: '0000000000000240000',
          secondaryValue: null,
          tiebreakValue: 150000,
          status: 'scored',
        }, // 4:00, tiebreak 2:30
        {
          sortKey: '0000000000000300000',
          secondaryValue: null,
          tiebreakValue: 180000,
          status: 'scored',
        }, // 5:00, tiebreak 3:00
        {
          sortKey: '0000000000000420000',
          secondaryValue: null,
          tiebreakValue: 240000,
          status: 'scored',
        }, // 7:00, tiebreak 4:00
        // Capped athletes (sorted by reps completed, then tiebreak)
        {
          ...
          tiebreakValue: 480000,
          status: 'cap',
        }, // 42 reps (21+15+6), tb 8:00
        {
          sortKey: '1152921504606846975',
          secondaryValue: 42,
          tiebreakValue: 540000,
          status: 'cap',
        }, // 42 reps, tb 9:00 (same reps, slower tb)
        {
          sortKey: '1152921504606846975',
          secondaryValue: 36,
          tiebreakValue: 420000,
          status: 'cap',
        }, // 36 reps (21+15), tb 7:00
        {
          sortKey: '1152921504606846975',
          secondaryValue: 30,
          tiebreakValue: 360000,
          status: 'cap',
        }, // 30 reps, tb 6:00
      ]
