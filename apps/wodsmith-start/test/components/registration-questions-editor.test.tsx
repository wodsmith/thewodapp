...
describe("organizer registration question option field composition", () => {
  beforeEach(() => {
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Field composition#Registration option field groups#Organizer registration option editing]]
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Field composition#Registration option field groups#Organizer registration option validation]]
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Field composition#Registration option field groups#Organizer registration option create payload]]
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Field composition#Registration option field groups#Organizer registration option update payload]]
