...
describe("OrganizerCompetitionForm", () => {
  // @lat: [[competition-type-capabilities#Benchmark Rollout Gates#Entitled Create Picker]]
  it("includes benchmark for an entitled organizing team", () => {
  ...
  it("keeps standard competition types available without benchmark access", () => {
    const { container } = render(
      <OrganizerCompetitionForm
