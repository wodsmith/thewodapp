...
describe("organizer scaling group dialog field composition", () => {
  beforeEach(() => {
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Field composition#Scaling level field groups#Organizer scaling level create]]
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Field composition#Scaling level field groups#Organizer scaling level validation]]
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Field composition#Scaling level field groups#Organizer scaling level update]]
