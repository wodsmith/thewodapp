...
function SeriesMappingBanner({
		...
		return (
			<Alert className="border-blue-200 bg-blue-50 dark:bg-blue-950/20">
				...
				<AlertDescription className="text-blue-700 dark:text-blue-300">
					<p>
						This competition is part of a series but no global
						leaderboard template has been configured yet.
					</p>
					<Button
						variant="outline"
						size="sm"
	...
	const allMapped =
		status.divisions.length > 0 && unmapped.length === 0
