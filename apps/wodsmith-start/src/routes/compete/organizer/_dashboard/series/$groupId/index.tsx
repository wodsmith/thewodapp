  ...
  loader: async ({ params, context }) => {
    ...
    if (!groupResult.group) {
      return {
        ...
        deferredDivisionHealth: Promise.resolve({
          health: [],
...
function SeriesDetailPage() {
  ...
  const handleFixAll = async () => {
    ...
    try {
      ...
      if (failed.length === 0) {
        toast.success(
          `All competitions aligned to the selected division template`,
        )
      } else {
        toast.warning(
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                competitions should use this template so athletes can be
                compared on the global leaderboard.
              </CardDescription>
            </CardHeader>
            <CardContent>
