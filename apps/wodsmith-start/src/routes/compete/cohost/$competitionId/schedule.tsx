 ...
 * Renders the shared organizer SchedulePage with cohost-permissioned heat
 * schedule overrides so the page stays in sync with the organizer route.
 */
...
import { SchedulePage } from "../../organizer/$competitionId/-pages/schedule-page"

// Get parent route API to access competition data
const parentRoute = getRouteApi("/compete/cohost/$competitionId")

export const Route = createFileRoute("/compete/cohost/$competitionId/schedule")(
  {
    staleTime: 10_000,
