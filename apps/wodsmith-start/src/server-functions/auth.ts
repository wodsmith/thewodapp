 ...
 */
export const signInAction = createServerFn("POST", async (_input: { email: string; password: string }) => {
 ...
 */
export const signUpAction = createServerFn("POST", async (_input: { email: string; password: string; firstName: string; lastName: string; captchaToken?: string }) => {
 ...
 */
export const forgotPasswordAction = createServerFn("POST", async (_input: { email: string; captchaToken?: string }) => {
 ...
 */
export const resetPasswordAction = createServerFn("POST", async (_input: { token: string; password: string }) => {
 ...
 */
export const verifyEmailAction = createServerFn("POST", async (_input: { token: string }) => {
 ...
 * Adds user to team
 */
export const acceptTeamInviteAction = createServerFn("POST", async (_input: { token: string }) => {
