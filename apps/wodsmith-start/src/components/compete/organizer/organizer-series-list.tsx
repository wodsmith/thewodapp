...
export function OrganizerSeriesList({
	...
	const handleDelete = (groupId: string) => {
		deleteGroupMutation.mutate({ groupId, organizingTeamId: teamId })
	}
						...
						<CardHeader>
							<div className="flex items-start justify-between">
								<div className="flex-1 min-w-0">
									<Link to={`/compete/organizer/series/$groupId`} params={{ groupId: group.id }}>
								...
								<DropdownMenu>
									...
									<DropdownMenuContent align="end">
										...
										<DropdownMenuItem asChild>
											<Link to={`/compete/organizer/series/$groupId/edit`} params={{ groupId: group.id }}>
												<Pencil className="h-4 w-4 mr-2" />
												Edit
											</Link>
										</DropdownMenuItem>
