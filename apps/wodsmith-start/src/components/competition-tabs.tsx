...
export function CompetitionTabs({ slug }: CompetitionTabsProps) {
  ...
  return (
    <div className="rounded-2xl border border-border bg-background/80 p-2 backdrop-blur-md">
      {/* Mobile: Select menu */}
      <div className="sm:hidden">
        <Select value={getActiveTabValue()} onValueChange={handleSelectChange}>
          <SelectTrigger className="w-full bg-transparent border-0 h-10 font-medium text-foreground">
