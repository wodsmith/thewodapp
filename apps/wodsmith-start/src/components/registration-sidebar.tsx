...
export function RegistrationSidebar({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Volunteer tools are capability-gated even for existing role holders. */}
      {isVolunteer &&
        (competitionCan(competition.competitionType, "volunteerShifts") ||
          competitionCan(competition.competitionType, "dayOfCheckIn")) && (
