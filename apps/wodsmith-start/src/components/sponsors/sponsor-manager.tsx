...
export function SponsorManager({
  ...
  const handleCreateGroup = async (name: string) => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : 'Failed to create sponsor group'
      toast.error(message)
    } finally {
  ...
  const handleUpdateGroup = async (groupId: string, name: string) => {
    try {
      ...
      const message =
        error instanceof Error ? error.message : 'Failed to update sponsor group'
      toast.error(message)
    }
  }
  ...
  const handleDeleteGroup = async (groupId: string) => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : 'Failed to delete sponsor group'
      toast.error(message)
    }
  }
      ...
      const updateInList = (sponsor: Sponsor) =>
        sponsor.id === sponsorId
          ? {
              ...
              logoUrl: data.logoUrl === undefined ? sponsor.logoUrl : data.logoUrl,
              website: data.website === undefined ? sponsor.website : data.website,
              groupId: data.groupId === undefined ? sponsor.groupId : data.groupId,
            }
          : sponsor
  ...
  const handleReorderGroups = async (sourceIndex: number, targetIndex: number) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Sponsor Groups</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-sm mb-6">
              Add sponsors to showcase your competition partners. Create groups like
              &quot;Gold&quot;, &quot;Silver&quot;, &quot;Bronze&quot; to organize them.
            </p>
            <div className="flex gap-2">
              <Button variant="outline" onClick={() => setShowAddGroupDialog(true)}>
                <Plus className="mr-2 h-4 w-4" />
