...
INSERT INTO `__new_team`("createdAt", "updatedAt", "updateCounter", "id", "name", "slug", "description", "avatarUrl", "settings", "billingEmail", "planId", "planExpiresAt", "creditBalance", "defaultTrackId") 
SELECT "createdAt", "updatedAt", "updateCounter", "id", "name", "slug", "description", "avatarUrl", "settings", "billingEmail", "planId", "planExpiresAt", "creditBalance", "defaultTrackId" FROM `team`;
