...
ALTER TABLE `programming_track` ADD `competitionId` text REFERENCES competitions(id) ON DELETE CASCADE;--> statement-breakpoint
...
CREATE UNIQUE INDEX `track_workout_unique_idx` ON `track_workout` (`trackId`,`workoutId`,`trackOrder`);--> statement-breakpoint
