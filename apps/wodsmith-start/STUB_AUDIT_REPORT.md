...
| HIGH | 11 | Important stubs that impact key features |
| MEDIUM | 8 | Partial implementations or placeholders |
...
### 4. Inline Signup Not Implemented
...
### 6. Missing Error Toast in Rotation Timeline
...
### 7. Judge Scheduling Placeholder
...
### 8. Scaling Migration Hardcoded Values
