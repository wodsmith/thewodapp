/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2cf6f71f7840b6ffac87f6bc25e73caa)
// Runtime types generated with workerd@1.20251217.0 2025-09-02 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "WorkoutImportAgent";
	}
	interface Env {
		...
		WORKOUT_IMPORT_GATEWAY: "wodsmith-import-prod";
		...
		OPENAI_MODEL_LARGE: string;
		OPENAI_MODEL_MEDIUM: string;
		OPENAI_MODEL_SMALL: string;
		BRAINTRUST_API_KEY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_VECTORIZE_API_TOKEN: string;
		ALCHEMY_PASSWORD: string;
		SENTRY_DSN: string;
		WORKOUT_IMPORT_AGENT: DurableObjectNamespace<import("./src/server").WorkoutImportAgent>;
		WORKOUT_IMPORT_SOURCES: R2Bucket;
		R2_BUCKET: R2Bucket;
		R2_DOWNLOADS_BUCKET: R2Bucket;
		wodsmith_uploads_dev: R2Bucket;
		WORKOUT_IMPORT_IMAGES: ImagesBinding;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "EMAIL_FROM_NAME" | "EMAIL_REPLY_TO" | "WORKOUT_IMPORT_GATEWAY" | "R2_PUBLIC_URL" | "POSTHOG_KEY" | "TURNSTILE_SITE_KEY" | "STRIPE_SECRET_KEY" | "VITE_STRIPE_PUBLISHABLE_KEY" | "STRIPE_CLIENT_ID" | "STRIPE_WEBHOOK_SECRET" | "VITE_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "EMAIL_TEST_MODE" | "BREVO_API_KEY" | "APP_URL" | "OPENAI_API_KEY" | "OPENAI_MODEL_LARGE" | "OPENAI_MODEL_MEDIUM" | "OPENAI_MODEL_SMALL" | "BRAINTRUST_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_VECTORIZE_API_TOKEN" | "ALCHEMY_PASSWORD" | "SENTRY_DSN">> {}
}
