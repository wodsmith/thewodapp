      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width-mobile) max-w-[calc(100%-1rem)] p-0 text-sidebar-foreground"
            background="sidebar"
            side={side}
          >
            ...
            <div className="flex min-h-full w-full flex-col pb-[env(safe-area-inset-bottom)]">
              {children}
            </div>
          </SheetContent>
        </Sheet>
