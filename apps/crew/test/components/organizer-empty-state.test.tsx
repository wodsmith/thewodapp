...
describe("OrganizerEmptyState", () => {
  // @lat: [[lat.md/ui-library#UI Library#Current boundary#Empty state composition#Organizer compatibility adapter#Crew adapter#Plain presentation]]
  ...
  // @lat: [[lat.md/ui-library#UI Library#Current boundary#Empty state composition#Organizer compatibility adapter#Crew adapter#Card presentation]]
  ...
  // @lat: [[lat.md/ui-library#UI Library#Current boundary#Empty state composition#Organizer compatibility adapter#Crew adapter#Incomplete actions]]
  ...
  // @lat: [[lat.md/ui-library#UI Library#Current boundary#Empty state composition#Organizer compatibility adapter#Crew adapter#Action behavior]]
  ...
  // @lat: [[lat.md/ui-library#UI Library#Current boundary#Empty state composition#Organizer compatibility adapter#Crew adapter#Mirrored source parity]]
  it("stays byte-identical to the Start compatibility adapter", () => {
    ...
    const startSource = readFileSync(
      resolve(
        process.cwd(),
        "../wodsmith-start/src/components/organizer/empty-state.tsx",
      ),
      "utf8",
    )

    expect(crewSource).toBe(startSource)
  })
})
