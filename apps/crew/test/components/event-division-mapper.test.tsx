...
describe("organizer event division prerequisites", () => {
  // @lat: [[ui-library#UI Library#Current boundary#Empty state composition#Direct organizer consumers#Crew event mapping event prerequisite]]
  ...
  // @lat: [[ui-library#UI Library#Current boundary#Empty state composition#Direct organizer consumers#Crew event mapping division prerequisite]]
