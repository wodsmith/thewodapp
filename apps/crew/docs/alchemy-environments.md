...
export ALCHEMY_PASSWORD="replace_me_alchemy_value"

# Different passwords per environment (optional but recommended)
export ALCHEMY_PASSWORD_PROD="replace_me_production_alchemy_value"
```
...
ALCHEMY_PASSWORD=replace_me_dev_alchemy_value

# prod should use a strong, unique password
ALCHEMY_PASSWORD=$(openssl rand -hex 32)
```
