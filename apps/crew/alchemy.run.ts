/**
 * @fileoverview Alchemy Infrastructure-as-Code configuration for WODsmith Crew.
 *
 ...
 * for the WODsmith Crew TanStack Start application.
 *
  ...
  stage === "dev"
    ...
    : await AiGateway(`ai-gateway-${stage}`, {
        ...
        apiToken: alchemy.secret(
          // biome-ignore lint/style/noNonNullAssertion: Required for managed AI Gateway deploys outside dev.
...
const website = await TanStackStart("app", {
  ...
  bindings: {
    ...
    POSTHOG_KEY: "replace_me_posthog_project_key",
