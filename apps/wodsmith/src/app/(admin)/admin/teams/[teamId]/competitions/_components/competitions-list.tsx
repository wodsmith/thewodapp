...
import { Calendar, Filter, MoreHorizontal, Pencil, Trash2 } from "lucide-react"
...
export function CompetitionsList({
	...
	const handleGroupFilter = (value: string) => {
		if (value === "all") {
			...
			router.push(`/admin/teams/${teamId}/competitions?groupId=${value}`)
		}
	}
								...
								<CardHeader>
									<div className="flex items-start justify-between">
										<div className="flex-1 min-w-0">
											<Link
												href={`/admin/teams/${teamId}/competitions/${competition.id}`}
											>
