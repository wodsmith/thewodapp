...
import { CompetitionGroupActions } from "../../../[teamId]/competitions/series/[groupId]/_components/competition-group-actions"
			...
			<Card>
				<CardHeader>
					<div className="flex items-center justify-between">
						...
						<Link href={`/admin/teams/competitions/new?groupId=${groupId}`}>
