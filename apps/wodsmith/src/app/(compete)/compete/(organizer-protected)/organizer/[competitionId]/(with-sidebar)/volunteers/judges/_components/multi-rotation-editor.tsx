...
import { z } from "zod"
import {
	batchCreateRotationsAction,
	batchUpdateVolunteerRotationsAction,
...
export function MultiRotationEditor({
	...
	const batchCreate = useServerAction(batchCreateRotationsAction)
	const batchUpdate = useServerAction(batchUpdateVolunteerRotationsAction)
		...
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
				...
				<div className="flex justify-end gap-2 pt-2">
					...
					<Button
						type="submit"
						disabled={isEditing ? batchUpdate.isPending : batchCreate.isPending}
					>
						{(isEditing ? batchUpdate.isPending : batchCreate.isPending) && (
