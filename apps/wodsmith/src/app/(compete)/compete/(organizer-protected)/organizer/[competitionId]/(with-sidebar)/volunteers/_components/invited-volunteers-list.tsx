...
import type { DirectVolunteerInvite } from "@/server/volunteers"
...
/**
 * Client component for displaying direct volunteer invitations
 * Shows invitation details with copy-to-clipboard functionality for invite links
 */
export function InvitedVolunteersList({ invites }: InvitedVolunteersListProps) {
	const [copiedToken, setCopiedToken] = useState<string | null>(null)

	/**
	 * Copy invite link to clipboard and show toast feedback
	 */
	...
	/**
	 * Format role types for display (replace underscores, capitalize)
	 */
	...
	const getStatusBadgeVariant = (
		...
		switch (status) {
			...
			case "accepted":
				return "default" // Green (via default theme)
			case "expired":
