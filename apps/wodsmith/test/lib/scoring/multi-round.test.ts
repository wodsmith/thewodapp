...
describe("Multi-Round Workouts", () => {
	...
	describe("5K Row Split Times (time, distance intervals)", () => {
		...
		it("should aggregate with sum (total time)", () => {
			...
			const expected = (112 + 114 + 115 + 116 + 118 + 120 + 118 + 115 + 112 + 108) * 1000
		...
		it("should aggregate with average (average split)", () => {
			const result = encodeRounds(rounds, "time", "average")
			// Average of splits
			const totalSeconds = 112 + 114 + 115 + 116 + 118 + 120 + 118 + 115 + 112 + 108
	...
	describe("CrossFit Total (load, 3 lifts)", () => {
		...
		it("should handle nested aggregation (best of each, then sum)", () => {
			...
			const squatResult = encodeRounds(squatAttempts, "load", "max", { unit: "lbs" })
			...
			const pressResult = encodeRounds(pressAttempts, "load", "max", { unit: "lbs" })
			...
			const deadliftResult = encodeRounds(deadliftAttempts, "load", "max", { unit: "lbs" })
