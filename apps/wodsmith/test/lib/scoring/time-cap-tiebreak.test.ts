...
describe("Complex Sorting Scenarios", () => {
	...
	describe("Higher is better schemes (reps, load)", () => {
		...
		it("should sort rounds-reps correctly (higher is better)", () => {
			const scores: Score[] = [
				{ scheme: "rounds-reps", scoreType: "max", value: 500010, status: "scored" }, // 5+10
				{ scheme: "rounds-reps", scoreType: "max", value: 600005, status: "scored" }, // 6+5
				{ scheme: "rounds-reps", scoreType: "max", value: 500020, status: "scored" }, // 5+20
			]
