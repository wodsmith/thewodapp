...
import { HeatQueueDashboard } from "@/components/heat-queue-dashboard"
...
export default function HomePage() {
  ...
  const handleHeatSelect = (heatId: string) => {
    router.push(`/heat/${heatId}`)
  }

  const handleCoordinatorMode = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeatQueueDashboard heats={mockHeats} onHeatSelect={handleHeatSelect} onCoordinatorMode={handleCoordinatorMode} />
    </div>
  )
}
