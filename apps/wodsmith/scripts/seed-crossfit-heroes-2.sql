...
Hogan is survived by his parents, Richard and Jean; and sister, Nicole.', 'time', 'public', 'team_cokkpu1klwo0ulfhl1iwzpvn', 1, strftime('%s', 'now'), strftime('%s', 'now'), 0),
...
He is survived by his wife, Holly; daughters, Brooklyn and Jordan; parents, William and Candy; brothers, Brian, Ken and Brad; grandmother, Romanita Rodriguez; and eight nieces and nephews.', 'rounds-reps', 'public', 'team_cokkpu1klwo0ulfhl1iwzpvn', 1, strftime('%s', 'now'), strftime('%s', 'now'), 0),
...
He is survived by his wife, Stacey; son, Charlie Ray; and daughters, Robin Parker and Sarah.', 'time', 'public', 'team_cokkpu1klwo0ulfhl1iwzpvn', 1, strftime('%s', 'now'), strftime('%s', 'now'), 0),
...
He is survived by his wife, Cassy; daughter, Serene; parents, Romel Mathias and Joseph Malin; brother and sister-in-law, Alex and Britton; and brother, Chance Hildreth.', 'time', 'public', 'team_cokkpu1klwo0ulfhl1iwzpvn', 1, strftime('%s', 'now'), strftime('%s', 'now'), 0),
...
He is survived by his wife, Regina; son, Ian; and daughter, Kaitlyn.', 'time', 'public', 'team_cokkpu1klwo0ulfhl1iwzpvn', 1, strftime('%s', 'now'), strftime('%s', 'now'), 0),
...
Servais is survived by his parents, Peter and Susan; and sister, Laura.', 'time', 'public', 'team_cokkpu1klwo0ulfhl1iwzpvn', 1, strftime('%s', 'now'), strftime('%s', 'now'), 0);
...
-- Shawn workout tags
('wtag_shawn_hero', 'wod_shawn', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_shawn_benchmark', 'wod_shawn', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0),
-- Foo workout tags
('wtag_foo_hero', 'wod_foo', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_foo_benchmark', 'wod_foo', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0),
-- Bowen workout tags
('wtag_bowen_hero', 'wod_bowen', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_bowen_benchmark', 'wod_bowen', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0),
-- Gaza workout tags
('wtag_gaza_hero', 'wod_gaza', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_gaza_benchmark', 'wod_gaza', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0),
-- Crain workout tags
('wtag_crain_hero', 'wod_crain', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_crain_benchmark', 'wod_crain', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0),
-- Capoot workout tags
('wtag_capoot_hero', 'wod_capoot', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_capoot_benchmark', 'wod_capoot', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0),
-- Hall workout tags
('wtag_hall_hero', 'wod_hall', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_hall_benchmark', 'wod_hall', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0),
-- Servais workout tags
('wtag_servais_hero', 'wod_servais', 'tag_hero', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wtag_servais_benchmark', 'wod_servais', 'tag_benchmark', strftime('%s', 'now'), strftime('%s', 'now'), 0);
...
('wm_shawn_run', 'wod_shawn', 'mov_run', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_shawn_airsquat', 'wod_shawn', 'mov_airsquat', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_shawn_pushup', 'wod_shawn', 'mov_pushup', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Foo: Bench press, Chest-to-bar pull-ups, Double-unders, Squat clean thrusters, Sit-ups
('wm_foo_benchpress', 'wod_foo', 'mov_benchpress', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_foo_ctbpullup', 'wod_foo', 'mov_ctbpullup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_foo_doubleunder', 'wod_foo', 'mov_doubleunder', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_foo_thruster', 'wod_foo', 'mov_thruster', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_foo_situp', 'wod_foo', 'mov_situp', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Bowen: Run, Deadlifts, Burpee pull-ups, Kettlebell thrusters, Box jumps
('wm_bowen_run', 'wod_bowen', 'mov_run', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_bowen_deadlift', 'wod_bowen', 'mov_deadlift', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_bowen_pullup', 'wod_bowen', 'mov_pullup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_bowen_burpee', 'wod_bowen', 'mov_burpee', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_bowen_thruster', 'wod_bowen', 'mov_thruster', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_bowen_boxjump', 'wod_bowen', 'mov_boxjump', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Gaza: Kettlebell swings, Push-ups, Pull-ups, Box jumps, Run
('wm_gaza_kbswing', 'wod_gaza', 'mov_kbswing', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_gaza_pushup', 'wod_gaza', 'mov_pushup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_gaza_pullup', 'wod_gaza', 'mov_pullup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_gaza_boxjump', 'wod_gaza', 'mov_boxjump', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_gaza_run', 'wod_gaza', 'mov_run', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Crain: Push-ups, Sprint (run), Deadlifts, Box jumps, Clean and jerk, Burpees, Wall-ball shots, Pull-ups
('wm_crain_pushup', 'wod_crain', 'mov_pushup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_crain_run', 'wod_crain', 'mov_run', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_crain_deadlift', 'wod_crain', 'mov_deadlift', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_crain_boxjump', 'wod_crain', 'mov_boxjump', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_crain_cleanjerk', 'wod_crain', 'mov_cleanjerk', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_crain_burpee', 'wod_crain', 'mov_burpee', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_crain_wallball', 'wod_crain', 'mov_wallball', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_crain_pullup', 'wod_crain', 'mov_pullup', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Capoot: Push-ups, Run
('wm_capoot_pushup', 'wod_capoot', 'mov_pushup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_capoot_run', 'wod_capoot', 'mov_run', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Hall: Cleans, Sprint (run), Kettlebell snatches
('wm_hall_clean', 'wod_hall', 'mov_clean', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_hall_run', 'wod_hall', 'mov_run', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_hall_kbswing', 'wod_hall', 'mov_kbswing', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Servais: Run, Pull-ups, Push-ups, Burpees (no movements for sandbag/farmers carry in seed)
('wm_servais_run', 'wod_servais', 'mov_run', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_servais_pullup', 'wod_servais', 'mov_pullup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('wm_servais_pushup', 'wod_servais', 'mov_pushup', strftime('%s', 'now'), strftime('%s', 'now'), 0),
