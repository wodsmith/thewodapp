...
('trwk_heroes_jt', 'ptrk_heroes', 'wod_jt', 1, 'Classic Hero WOD - handstand push-ups, ring dips, push-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_michael', 'ptrk_heroes', 'wod_michael', 2, 'Running with posterior chain work', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_murph', 'ptrk_heroes', 'wod_murph', 3, 'Memorial Day Hero - the ultimate test', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_daniel', 'ptrk_heroes', 'wod_daniel', 4, 'Mixed modal chipper with thrusters', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_josh', 'ptrk_heroes', 'wod_josh', 5, 'Overhead squats and pull-ups ladder', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_jason', 'ptrk_heroes', 'wod_jason', 6, 'Squats and muscle-ups ascending ladder', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_badger', 'ptrk_heroes', 'wod_badger', 7, 'Squat cleans, pull-ups, and running', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_joshie', 'ptrk_heroes', 'wod_joshie', 8, 'Unilateral dumbbell snatches and L pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_nate', 'ptrk_heroes', 'wod_nate', 9, 'AMRAP with advanced gymnastic movements', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_randy', 'ptrk_heroes', 'wod_randy', 10, 'Simple but brutal - 75 power snatches', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_tommy_v', 'ptrk_heroes', 'wod_tommy_v', 11, 'Thrusters and rope climbs descending ladder', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_griff', 'ptrk_heroes', 'wod_griff', 12, 'Running forward and backward', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_ryan', 'ptrk_heroes', 'wod_ryan', 13, 'Muscle-ups and burpees combination', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_erin', 'ptrk_heroes', 'wod_erin', 14, 'Dumbbell split cleans and pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_mr_joshua', 'ptrk_heroes', 'wod_mr_joshua', 15, 'Running, GHD sit-ups, and heavy deadlifts', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_dt', 'ptrk_heroes', 'wod_dt', 16, 'Classic barbell triplet - deadlifts, cleans, jerks', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_danny', 'ptrk_heroes', 'wod_danny', 17, 'AMRAP with box jumps, push press, pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_hansen', 'ptrk_heroes', 'wod_hansen', 18, 'Kettlebell swings, burpees, GHD sit-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_tyler', 'ptrk_heroes', 'wod_tyler', 19, 'Muscle-ups and sumo deadlift high pulls', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_lumberjack_20', 'ptrk_heroes', 'wod_lumberjack_20', 20, 'Long chipper honoring Fort Hood heroes', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_stephen', 'ptrk_heroes', 'wod_stephen', 21, 'Descending ladder with posterior chain focus', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_garrett', 'ptrk_heroes', 'wod_garrett', 22, 'Advanced gymnastics with ring HSPU and L pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_war_frank', 'ptrk_heroes', 'wod_war_frank', 23, 'High volume muscle-ups with squats and sit-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_mcghee', 'ptrk_heroes', 'wod_mcghee', 24, 'Long AMRAP with heavy deadlifts', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_paul', 'ptrk_heroes', 'wod_paul', 25, 'Double-unders, knees-to-elbows, overhead walk', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_jerry', 'ptrk_heroes', 'wod_jerry', 26, 'Pure cardio - run and row combination', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_nutts', 'ptrk_heroes', 'wod_nutts', 27, 'Multi-modal chipper with varied movements', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_arnie', 'ptrk_heroes', 'wod_arnie', 28, 'Single kettlebell complex workout', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_the_seven', 'ptrk_heroes', 'wod_the_seven', 29, 'Seven movements, seven reps, seven rounds', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_rj', 'ptrk_heroes', 'wod_rj', 30, 'Running, rope climbs, and push-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_luce', 'ptrk_heroes', 'wod_luce', 31, 'Weighted vest workout with muscle-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_johnson', 'ptrk_heroes', 'wod_johnson', 32, 'Heavy AMRAP with deadlifts, muscle-ups, cleans', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_roy', 'ptrk_heroes', 'wod_roy', 33, 'Deadlifts, box jumps, and pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_adambrown', 'ptrk_heroes', 'wod_adambrown', 34, 'Heavy chipper with bench press', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_coe', 'ptrk_heroes', 'wod_coe', 35, 'High volume thrusters and ring push-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- New Hero workouts in programming track
('trwk_heroes_severin', 'ptrk_heroes', 'wod_severin', 36, 'Strict pull-ups, hand-release push-ups, and 5K run with optional vest', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_helton', 'ptrk_heroes', 'wod_helton', 37, 'Running and dumbbell squat cleans with burpees', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_jack', 'ptrk_heroes', 'wod_jack', 38, 'AMRAP with push press, kettlebell swings, and box jumps', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_forrest', 'ptrk_heroes', 'wod_forrest', 39, 'Advanced gymnastics with L pull-ups and toes-to-bars', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_bulger', 'ptrk_heroes', 'wod_bulger', 40, 'High volume rounds with running and gymnastics', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_brenton', 'ptrk_heroes', 'wod_brenton', 41, 'Unique movement pattern with bear crawl and broad jumps', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_blake', 'ptrk_heroes', 'wod_blake', 42, 'Overhead lunges, box jumps, wall balls, and handstand push-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Second batch Hero workouts in programming track
('trwk_heroes_collin', 'ptrk_heroes', 'wod_collin', 43, 'Sandbag carry with strength and conditioning movements', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_thompson', 'ptrk_heroes', 'wod_thompson', 44, 'Rope climbs with heavy back squats and farmers carry', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_whitten', 'ptrk_heroes', 'wod_whitten', 45, 'High volume rounds with varied movements', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_bull', 'ptrk_heroes', 'wod_bull', 46, 'Long chipper with double-unders, squats, and running', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_rankel', 'ptrk_heroes', 'wod_rankel', 47, 'AMRAP with heavy deadlifts and burpee pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_holbrook', 'ptrk_heroes', 'wod_holbrook', 48, 'Interval format with thrusters, pull-ups, and sprints', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_ledesma', 'ptrk_heroes', 'wod_ledesma', 49, 'Advanced gymnastics AMRAP with parallette HSPU', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_wittman', 'ptrk_heroes', 'wod_wittman', 50, 'Barbell and conditioning triplet', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_mccluskey', 'ptrk_heroes', 'wod_mccluskey', 51, 'Advanced gymnastics with muscle-ups and burpee pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Third batch Hero workouts in programming track
('trwk_heroes_weaver', 'ptrk_heroes', 'wod_weaver', 52, 'High volume pull-ups and push-ups combination', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_abbate', 'ptrk_heroes', 'wod_abbate', 53, 'Running and clean and jerks endurance test', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_hammer', 'ptrk_heroes', 'wod_hammer', 54, 'Interval barbell complex with pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_moore', 'ptrk_heroes', 'wod_moore', 55, 'AMRAP with rope climbs, running, and max HSPU', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_wilmot', 'ptrk_heroes', 'wod_wilmot', 56, 'Simple but brutal squats and ring dips', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_moon', 'ptrk_heroes', 'wod_moon', 57, 'Unilateral dumbbell work with rope climbs', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_small', 'ptrk_heroes', 'wod_small', 58, 'Mixed modal chipper with rowing and running', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_morrison', 'ptrk_heroes', 'wod_morrison', 59, 'Descending ladder with wall balls, box jumps, KB swings', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_manion', 'ptrk_heroes', 'wod_manion', 60, 'Running and heavy back squats combination', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_gator', 'ptrk_heroes', 'wod_gator', 61, 'Heavy front squats with ring push-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Fourth batch Hero workouts in programming track
('trwk_heroes_bradley', 'ptrk_heroes', 'wod_bradley', 62, 'Sprint intervals with pull-ups and burpees', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_meadows', 'ptrk_heroes', 'wod_meadows', 63, 'Advanced ring skills chipper', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_santiago', 'ptrk_heroes', 'wod_santiago', 64, 'Dumbbell and barbell combination with gymnastics', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_carse', 'ptrk_heroes', 'wod_carse', 65, 'Descending ladder with bear crawl starts', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_bradshaw', 'ptrk_heroes', 'wod_bradshaw', 66, 'High volume gymnastics and lifting combination', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_white', 'ptrk_heroes', 'wod_white', 67, 'Rope climbs with overhead lunges and running', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_santora', 'ptrk_heroes', 'wod_santora', 68, 'Interval format with barbell movements and burpees', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_wood', 'ptrk_heroes', 'wod_wood', 69, 'Mixed modal with rest intervals', strftime('%s', 'now'), strftime('%s', 'now'), 0),

-- Sixth batch Hero workouts in programming track
('trwk_heroes_klepto', 'ptrk_heroes', 'wod_klepto', 70, 'Box jumps, burpees, and squat cleans', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_del', 'ptrk_heroes', 'wod_del', 71, 'Medicine ball runs with varied gymnastics', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_pheezy', 'ptrk_heroes', 'wod_pheezy', 72, 'Heavy barbell movements with gymnastics', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_jj', 'ptrk_heroes', 'wod_jj', 73, 'Ascending/descending ladder with parallette HSPU', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_jag_28', 'ptrk_heroes', 'wod_jag_28', 74, 'Running with kettlebell work and strict pull-ups', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_brian', 'ptrk_heroes', 'wod_brian', 75, 'Rope climbs with heavy back squats', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_nick', 'ptrk_heroes', 'wod_nick', 76, 'High volume dumbbell work', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_strange', 'ptrk_heroes', 'wod_strange', 77, 'Running with weighted gymnastics and kettlebells', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_tumilson', 'ptrk_heroes', 'wod_tumilson', 78, 'Short sprints with dumbbell burpee deadlifts', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_ship', 'ptrk_heroes', 'wod_ship', 79, 'Heavy squat cleans with high box jumps', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_jared', 'ptrk_heroes', 'wod_jared', 80, 'Classic running with gymnastics endurance', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_tully', 'ptrk_heroes', 'wod_tully', 81, 'Swimming with dumbbell squat cleans', strftime('%s', 'now'), strftime('%s', 'now'), 0),
('trwk_heroes_holleyman', 'ptrk_heroes', 'wod_holleyman', 82, 'High volume chipper with wall balls and power cleans', strftime('%s', 'now'), strftime('%s', 'now'), 0);
