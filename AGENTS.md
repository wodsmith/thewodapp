...
- Never pass `id` when inserting (auto-generated with ULID via `createXxxId()` helpers)
...
env.HYPERDRIVE // Hyperdrive binding (production) — exposes connectionString for PlanetScale
