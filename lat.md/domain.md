...
The focused boundaries in [[tests/workout-result-adapters#Workout-result Adapter Characterization]] retain deliberate compatibility differences: self-entry trusts explicit CAP and stores null invalid tiebreaks; verification direct overrides can retain stale rounds without clamping; manual entry trusts explicit CAP and couples score persistence to its audit/video transaction. Mobile competition submit/judge routes and Crew sharing remain outside this module rollout.
