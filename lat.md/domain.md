...
[ADR-0014](../docs/adr/0014-round-aware-multi-round-cap-scoring-followup.md) requires the public leaderboard to show the aggregate plus the full round breakdown, including per-round cap state and reps-at-cap.
