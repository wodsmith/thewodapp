...
Volunteer server-function tests stub a competition with no volunteer-required waivers when they assert signup duplicate detection and account/application creation behavior.
